...
const Register = () => {
  ...
  return (
    <div className=" grid md:grid-cols-3 min-h-screen  overflow-hidden">
      ...
      <div className="grid col-span-3 md:col-span-1  md:bg-orange rounded-tl-3xl rounded-bl-3xl shadow-2xl h-full relative">
        <div className=" flex flex-col md:justify-center  items-center relative  ">
          <div className=" w-full h-screen   md:w-[400px] md:h-[50%] lg:h-[65%]   bg-white flex flex-col max-md:pt-28  px-6 py-5 pb-10 md:absolute right-[35%] 2xl:right-[50%]  rounded-lg  shadow-xl">
